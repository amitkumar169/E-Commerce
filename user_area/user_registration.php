                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                     ...
                     <div class="form-outline mb-4">
                        ...
                        <input type="file" id="user_image" class="form-control" autocomplete="off" 
...
user_ip,user_address,user_mobile) values ('$user_username','$user_email','$hash_password','$user_image',
