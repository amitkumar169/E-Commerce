...
<head>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="cart.php"><i class="fa-solid fa-cart-shopping"></i><sup>1</sup></sup></a>
        </li>
        <li class="nav-item">
        ...
        <div class="col-md-2 bg-secondary  p-0 mb-2">
            ...
            <ul class="navbar-nav me-auto text-center ">
                <li class="nav-item bg-info">
                    <a href="#" class="nav-link text-light "><h4 class="custom-css">Delivery Brands</h4></a>
                </li>
                <!--display brands data -->
                <?php
                getbrands();
