        ...
        <div class="row">
            ...
            <div class="d-flex mb-5">
                ...
                if($result_count>0){
                    ...
                    <input type='submit' value='Continue Shopping' class='bg-info px-3 py-2 border-0' name='continue_shoppoing'>
                   <button class='bg-secondary px-3 py-2 border-0 '> <a href='./user_area/checkout.php' class='text-light text-decoration-none' >Checkout
                   </a></button>
                </h4>";
                }
                else{
                    echo "<input type='submit' value='Continue Shopping' class='bg-info px-3 py-2 border-0' name='continue_shoppoing'>";
                }
                if(isset($_POST['continue_shoppoing'])){
